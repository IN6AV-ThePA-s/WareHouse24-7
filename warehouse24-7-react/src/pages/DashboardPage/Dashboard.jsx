...
export const Dashboard = () => {
    ...
    return (
        <>
            ...
            <header className="navbar navbar-dark bg-dark flex-md-nowrap p-0 shadow sticky-top">
                {/* <img className='ms-3' src={logo} width='35px' height='35px' /> */}
                <h1 className="brush navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6">WH 24/7</h1>
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <nav id="sidebarMenu" className={`col-md-3 col-lg-2 d-md-block bg-light sidebar ${open ? 'collapsing' :'collapse'}`} style={open?{height: '740px'}:{'':''}}>
